...
-- Using specific IDs: 52, 109, 110, 111, 139, 140
-- ============================================

-- BLOG 1 (ID: 52): How to Find the Right Articleship Opportunity as a CA Student
UPDATE frontends 
...
WHERE id = 52 AND data_keys = 'blog.element';

-- BLOG 2 (ID: 109): Why Internships and Articleship Matter for Career Growth
UPDATE frontends 
SET data_values = JSON_SET(
    data_values,
...
WHERE id = 109 AND data_keys = 'blog.element';

-- BLOG 3 (ID: 110): How Firms Can Find the Right Students for Training
UPDATE frontends 
SET data_values = JSON_SET(
    data_values,
...
WHERE id = 110 AND data_keys = 'blog.element';

-- BLOG 4 (ID: 111): Top Skills Every CA Articleship Student Should Develop
UPDATE frontends 
SET data_values = JSON_SET(
    data_values,
...
WHERE id = 111 AND data_keys = 'blog.element';

-- BLOG 5 (ID: 139): How Article Connect Helps Students Discover Career Opportunities
UPDATE frontends 
SET data_values = JSON_SET(
    data_values,
...
WHERE id = 139 AND data_keys = 'blog.element';

-- BLOG 6 (ID: 140): The Future of Student-Firm Collaboration
UPDATE frontends 
SET data_values = JSON_SET(
    data_values,
...
WHERE id = 140 AND data_keys = 'blog.element';
