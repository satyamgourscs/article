...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $val['name'] = auth()->guard('buyer')->user()->username;
        $val['description'] = "Payment By Razorpay";
        $val['image'] = siteLogo();
        $val['prefill.name'] = auth()->guard('buyer')->user()->firstname . ' ' . auth()->guard('buyer')->user()->lastname;
        $val['prefill.email'] = auth()->guard('buyer')->user()->email;
        $val['prefill.contact'] = auth()->guard('buyer')->user()->mobileNumber;
