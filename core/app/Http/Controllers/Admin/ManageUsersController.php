...
class ManageUsersController extends Controller
{
    ...
    {
        $pageTitle = 'Incomplete Profile Users';
        $users = $this->userData('incompleteProfile');
        return view('admin.users.list', compact('pageTitle', 'users'));
    }
    ...
    {
        $user = User::with(['badge', 'skills', 'educations', 'portfolios'])->findOrFail($id);
        $pageTitle = 'User Detail - ' . ($user->username ?? 'N/A');
        ...
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalWithdrawals', 'totalTransaction', 'countries', 'totalBids'));
    }
    ...
    public function analytics()
    {
        ...
        return view('admin.users.analytics', compact('pageTitle', 'newProjectThisMonth', 'newProjectThisWeek', 'newFreelancersThisMonth', 'newFreelancersThisWeek', 'topFreelancers', 'monthlyFreelancerGrowth', 'months'));
    }
}
