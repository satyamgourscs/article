        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                        @include('Template::partials.empty', ['message' => 'KYC data not found!'])
                    @endif

                    @if ($buyer->kv == Status::KYC_UNVERIFIED)
                        <div class="my-3">
                    ...
                    @if ($buyer->kv == Status::KYC_PENDING)
    ...
    <div id="kycRejectionModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.buyers.kyc.reject', $buyer->id) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="alert alert-primary p-3">
                            @lang('If you reject these documents, the buyer will be able to re-submit new documents and these documents will be replaced by new documents.')
                        </div>
