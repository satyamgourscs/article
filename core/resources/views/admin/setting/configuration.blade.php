                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li
                                ...
                                <div>
                                    <p class="fw-bold mb-0">@lang('Student Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no any student can register on this system.')</small>
                                    </p>
                                </div>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Firm Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no any firm can register on this system.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="buyer_registration"
                                        @if (gs('buyer_registration')) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Firm)')</span>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Escrow Payment')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable the escrow payment method, the buyer must have sufficient funds in their account to cover the project until it is completed and settled.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="escrow_payment"
                                        @if (gs('escrow_payment')) checked @endif>
                                </div>
                            </li>
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Auto Job Approval')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, firm opportunity posts will be automatically approved. Otherwise, the authority will manually handle the approval of posts for visibility.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        name="job_auto_approved" @if (gs('job_auto_approved')) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
