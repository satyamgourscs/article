                    ...
                    <ul class="list-group">
                        ...
                        @else
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold">
                                    <a
                                        href="{{ route('admin.buyers.detail', $withdrawal->buyer_id) }}"><span>@</span>{{ @$withdrawal->buyer->username }}</a>
                                </span>
                            </li>
                        @endif
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Rate')
                            <span class="fw-bold">1 {{ __(gs('cur_text')) }} = {{ showAmount($withdrawal->rate) }}</span>
                        </li>
