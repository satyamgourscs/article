                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($withdrawals as $withdraw)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="fw-bold">{{ $withdraw->buyer->fullname }}</span>
                                                <br>
                                                <span class="small"> <a
                                                        href="{{ appendQuery('search', @$withdraw->buyer->username) }}"><span>@</span>{{ $withdraw->buyer->username }}</a>
                                                </span>
                                            @endif
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td class="text-muted text-center" colspan="100%">{{ __($emptyMessage ?? 'No withdrawals found') }}</td>
                                    </tr>
                                @endforelse
