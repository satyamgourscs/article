    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.bids.index') }}?search={{ $user->username }}"
                        title="Bids" icon="las la-wallet" value="{{ $totalBids }}" bg="8" type="2" />
                </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                @if ($user->kyc_data)
                    <div class="flex-fill">
                        <a href="{{ route('admin.users.kyc.details', $user->id) }}" target="__blank"
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.users.login', $user->id) }}" target="__blank" class="btn btn-sm btn-outline--primary"><i class="las la-sign-in-alt"></i>@lang('Login as Student')</a>
@endpush
