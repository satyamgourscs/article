                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($item->buyer_id)
                                                <a href="{{ route('admin.buyers.detail', $item->buyer_id) }}">
                                                    {{ @$item->buyer->fullname }}</a>
                                            @else
                                            ...
                                            @elseif($item->buyer_id)
                                                <span class="badge badge--primary"> @lang('Firm')</span>
                                            @endif
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td class="text-muted text-center" colspan="100%">{{ __($emptyMessage ?? 'No tickets found') }}</td>
                                    </tr>
                                @endforelse
