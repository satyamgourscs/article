...
@section('panel')
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($logs as $log)
                                    ...
                                    @empty
                                        <tr>
                                            <td class="text-muted text-center" colspan="100%">{{ __($emptyMessage ?? 'No notification history found') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table><!-- table end -->
    ...
    @push('breadcrumb-plugins')
        ...
        @elseif(@$buyer)
            <a href="{{ route('admin.buyers.notification.single', $buyer->id) }}" class="btn btn-outline--primary btn-sm"><i
                    class="las la-paper-plane"></i> @lang('Send Notification')</a>
        @else
