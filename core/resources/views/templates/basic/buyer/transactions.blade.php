            ...
            <form>
                <div class="d-flex flex-wrap gap-4">
                    <div class="flex-grow-1">
                        <input type="search" name="search" value="{{ request()->search }}" placeholder="@lang('Transaction Number')"
                ...
                @empty
                    <tr>
                        <td class="text-muted text-center msg-center" colspan="100%">
                            @include('Template::partials.empty', ['message' => 'No transaction history found!'])
                        </td>
                    </tr>
                @endforelse
            </tbody>
