...
@section('content')
    <div class="container ">
        <div class="row justify-content-center my-60">
            <div class="col-xxl-9">
                <form action="{{ route('buyer.withdraw.money') }}" method="post" class="withdraw-form">
                    @csrf
                                ...
                                <div class="payment-system-list is-scrollable gateway-option-list">
                                    @foreach ($withdrawMethod as $data)
                                        <label for="{{ titleToKey($data->name) }}"
                                            ...
                                            <input class="payment-item__radio gateway-input" value="{{ $data->id }}" id="{{ titleToKey($data->name) }}" hidden
