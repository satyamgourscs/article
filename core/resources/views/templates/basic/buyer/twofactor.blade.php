            ...
            <div class="col-xl-5 col-lg-12 col-md-6">
                @if (auth()->guard('buyer')->user()->ts)
                    <div class="card custom--card h-auto">
                        ...
                        <form action="{{ route('buyer.twofactor.disable') }}" method="POST">
                            <div class="card-body">
                                @csrf
                ...
                @else
                    <div class="card custom--card h-auto">
                        ...
                        <form action="{{ route('buyer.twofactor.enable') }}" method="POST">
                            <div class="card-body">
                                @csrf
                                <input type="hidden" name="key" value="{{ $secret }}">
                                <div class="form-group">
