...
<div class="card custom--card">
    <div class="card-body">
        <form action="{{ route('buyer.ticket.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="register">
                <div class="row">
                    <div class="col-md-12">
                       <div class="form-group">
                        ...
                        <div class="support-priority-wrapper">
                            <label class="support-priority" for="low">
                                ...
                                <input id="low" name="priority" type="radio" required
                                    value="1" @checked(@old('priority') == 1)>
                                <span class="support-priority-circle">
                                    <svg class="check-circle" width="13" height="10"
                                        viewBox="0 0 13 10" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path class="check" d="M1 5L4.5 8.5L12.5 0.5"
                            ...
                            <label class="support-priority" for="medium">
                                ...
                                <input id="medium" name="priority" type="radio" required value="2" {{ old('priority', 2) == 2 ? 'checked' : '' }}>
                                <span class="support-priority-circle">
                                    <svg class="check-circle" width="13" height="10"
                                        viewBox="0 0 13 10" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <label class="support-priority" for="high">
                                ...
                                <input id="high" name="priority" required type="radio"
                                    value="3" @checked(@old('priority') == 3)>
                            </label>
                        </div>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input class="form--control form-control custom--file-input" name="attachments[]"
