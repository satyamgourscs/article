<div class="sidebar-wrapper">
        ...
        <div class="sidebar-header__content">
            @auth
                @php
                    ...
                    $applyCheck = $applyCheck ?? canApplyJob();
                    $applyDisabled = $isJobBidExisting > 0 || ! $freelancer->work_profile_complete || ! ($applyCheck['allowed'] ?? true);
                @endphp
                    <button type="button" class="btn btn--base w-100 mt-3 bidModalBtn @if ($applyDisabled) disabled @endif">
                        <i class="lab la-gavel"></i> @lang('Apply for this opportunity')
                    </button>
                ...
                @elseif ($isJobBidExisting > 0)
                    <small class="d-flex justify-content-center mt-1 text--warning">@lang('You already applied to this opportunity.')</small>
                @elseif (! ($applyCheck['allowed'] ?? true))
                    <small class="d-flex justify-content-center mt-1 text--danger">{{ $applyCheck['message'] ?? '' }}</small>
                    <a class="btn btn--dark btn--sm w-100 mt-2" href="{{ route('user.subscription.plans') }}">@lang('Upgrade Plan')</a>
                @endif
            @else
                <a class="text-center btn btn--base w-100" href="{{ route('user.login') }}" class="btn--base btn btn--lg">@lang('Apply for this opportunity')</a>
            @endauth
    ...
    <div class="sidebar-item buyer-info-item">
        <div class="top">
            <h6 class="sidebar-item__title"> @lang('About the Firm') </h6>
            ...
            <div class="project-info-wrapper">
                <div class="project-info__item">
                    ...
                    <div class="project-info__content">
                        ...
                        <span class="title"> {{ count($job->buyer->jobs) }} @lang('opportunities') </span>
                    </div>
                </div>
                <div class="project-info__item">
                    <span class="project-info__icon">
        ...
        <div class="sidebar-item__verify">
            ...
            <a href="javascript:void(0)" class="verify-item">
                ...
                <div class="verify-item__content">
                    ...
                    @else
                        <p class="verify-item__text unverified-text">@lang('Firm foster greater trust in our community') </p>
                    @endif
    ...
    <div class="sidebar-item">
        <h6 class="sidebar-item__title"> @lang('Similar opportunities') </h6>
        <ul class="job-list">
